/****************************************************************************
** Meta object code from reading C++ file 'SystemCall.hpp'
**
...
#error "The header file 'SystemCall.hpp' doesn't include <QObject>."
...
void SystemCall::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SystemCall *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SystemCall::staticMetaObject = { {
    QMetaObject::SuperData::link<MyObject::staticMetaObject>(),
    qt_meta_stringdata_SystemCall.data,
    qt_meta_data_SystemCall,
    qt_static_metacall,
    nullptr,
    nullptr
} };
