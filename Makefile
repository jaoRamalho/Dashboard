...
DISTDIR = /home/negodrama/Documents/Dashboard/entrega1/Dashboard/.tmp/dashboard1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/SystemCall.hpp include/mainwindow.h include/ThreadManager.hpp include/MyObject.hpp include/DataProvider.hpp include/ProcessInfo.h include/SystemCallCPU.hpp include/SystemCallMemory.hpp include/SystemCallProcesses.hpp include/SystemCallDisk.hpp include/SystemCallFiles.hpp include/Dashboard.hpp include/MyMutex.cpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/SystemCall.cpp src/mainwindow.cpp src/ThreadManager.cpp src/MyObject.cpp src/DataProvider.cpp src/SystemCallCPU.cpp src/SystemCallMemory.cpp src/SystemCallProcesses.cpp src/SystemCallDisk.cpp src/SystemCallFiles.cpp src/Dashboard.cpp src/MyMutex.cpp $(DISTDIR)/
